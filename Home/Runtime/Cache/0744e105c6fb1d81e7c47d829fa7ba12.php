...
<html>
	...
	<?php if(is_array($levelData)): $i = 0; $__LIST__ = $levelData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="row">
			<div class="col-md-12 text-center">
				<h2>
					<a href="__APP__/Train/showTaskList/id/<?php echo ($vo["id"]); ?>">
						<?php echo ($vo["entrance_title"]); ?>
					</a>
				</h2>
			</div>
